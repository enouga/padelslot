  ...
  async listClubResources(clubId: string) {
    const resources = await prisma.resource.findMany({
      ...
      select: {
        ...
        clubSport: { select: { id: true, slotStepMin: true, durationsMin: true, sport: { select: { key: true, name: true, resourceNoun: true, defaultSlotStepMin: true, defaultDurationsMin: true, surfaces: true } } } },
      },
    });
